...
class PipManager(Command):
    ...
    def __init__(self, installer_config, progress_tracker=None):
        ...
        if self.PypiMirror == "AUTO" or self.PypiMirror == "":
            self.PypiMirror = select_fastest_url(["https://pypi.org/simple", "http://pypi.tuna.tsinghua.edu.cn/simple", "http://mirrors.aliyun.com/pypi/simple", "https://mirrors.bfsu.edu.cn/pypi/web"])
